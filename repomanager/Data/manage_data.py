...
def fix_url(downstream):
    ...
    for i in range(len(df["sample_url"])):
        ...
        df.to_csv("./repomanager/Data/downstream_processed.csv")
...
up_train.to_csv(f"./repomanager/Data/training/{category}_up.csv")
down_train.to_csv(f"./repomanager/Data/training/{category}_down.csv")
up_test.to_csv(f"./repomanager/Data/testing/{category}_up.csv")
down_test.to_csv(f"./repomanager/Data/testing/{category}_down.csv")

#fix_url("./repomanager/Data/downstream_processed.csv")